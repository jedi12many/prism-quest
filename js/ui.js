...
const GUIDE_PAGES = [
  ...
  { icon: '💎', title: 'The shattered Prismblade', html: `The legendary <b>Prismblade</b> lies broken — one facet hidden in each land as a <b>shy glint in the grass</b>. It's easy to miss in the rain, but once you <b>beat that land's champion and the sun returns</b>, the shard catches the light and glints clearly. Each facet is a fine weapon alone; the village <b>Glassworks</b> fuses 2–4 into something far greater — find all four for total devastation.` },
