...
const GUIDE_PAGES = [
  ...
  { icon: '💎', title: 'The shattered Prismblade', html: `The legendary <b>Prismblade</b> lies broken — one facet hidden in each land as a <b>shy glint in the grass</b>. It's easy to miss in the rain, but once you <b>beat that land's champion and the sun returns</b>, the shard catches the light <b>now and then in a sparkle</b>. Each facet is a fine weapon alone; the village <b>Glassworks</b> fuses 2–4 into something far greater — find all four for total devastation.` },
...
function facetHint(s) {
  ...
  return `<br><br>✨ Old tale: the <b>Prismblade</b> shattered into four facets, one lost in each land. In the rain the shard is a <b>shy glint</b>, easy to miss — but once you <b>drive off a land's champion and the sun breaks through</b>, it catches the light <b>now and then in a sparkle</b> — keep your eyes on the grass. The ${missing.map(z => ZONES[z].dir).join(', ')} still hide${missing.length === 1 ? 's' : ''} theirs. The <b>Glassworks</b> kiln can fuse any two or more.`;
}
